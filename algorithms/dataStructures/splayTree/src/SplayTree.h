...
class SplayTree
{
  public:
	...
	/**
	* Returns the number of splays that occured on the tree;
	*/
	int getSplayCount()
	{
		return splays;
	...
	/**
	* Returns the element at the root node.
	*/
	...
	*/
	...
	/**
	* Prints all comparables that are derivatives of the input comparable
	*/
	void printDerivatives(Comparable& x)
	{
		printDerivatives(x, root);
	}
...
private:
	...
	int splays; // the number of splays
	...
	/**
	* Prints are the derivatives of x in the tree.
	*/
	void printDerivatives(Comparable& x, BinaryNode* t)
	{
		if( t != t->left )
        {
            printDerivatives( x, t->left );

			//if the element is derived from x then print it
			if (x % t->element) 
			{
				cout << t->element << endl;
			}

            printDerivatives( x, t->right );
        }
	}
   ...
   void printTree( BinaryNode *t ) const
    ...
    {
		splays++; //count the number of splays
